...
HD_PWD='C:/Users/user/lab7_1/lab7_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab7_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab7_1.tcl -notrace
