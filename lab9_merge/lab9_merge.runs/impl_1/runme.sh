...
HD_PWD='C:/Users/user/lab9_merge/lab9_merge.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab9.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab9.tcl -notrace
