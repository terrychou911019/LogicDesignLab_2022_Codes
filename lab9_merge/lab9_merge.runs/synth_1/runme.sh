...
HD_PWD='C:/Users/user/lab9_merge/lab9_merge.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab9.tcl
