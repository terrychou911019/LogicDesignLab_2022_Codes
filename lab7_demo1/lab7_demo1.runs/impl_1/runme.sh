...
HD_PWD='C:/Users/user/lab7_demo1/lab7_demo1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demo_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demo_1.tcl -notrace
